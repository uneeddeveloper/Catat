...
Untuk pengeluaran, cek juga apakah pesan menyebutkan secara eksplisit sumber dananya, contoh: "beli printer 5jt sumber dana dari dek", "bayar sewa 2jt pake kas toko", "beli bensin 50rb dari uang pribadi". Kalau ada, isi "sourceOfFunds" dengan sumber dana itu (mis. "dek", "kas toko", "uang pribadi") — ini BUKAN pihak penerima uang (merchant), tapi asal dana internal si pencatat. Kalau tidak disebutkan, atau transaksinya pemasukan, set sourceOfFunds ke null.`
      },
